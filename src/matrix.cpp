...
Changes made:
    - Removed FLOAT eps=1e-20 parameter from lu function (not used).
    - Added return d to det function.
    - Added initialization of icol and irow in function solve and imax in function lu to 0.
